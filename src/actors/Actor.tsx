    ...
    const generatedResponse = await stage.makeText({
        prompt: `{{messages}}This is preparatory request for structured and formatted game content.` +
            ...
            buildPromptSegment(`Instructions`, `After carefully considering this description and the rules provided, the System will generate a concise breakdown for a character based upon these details in the following strict format:\n` +
                ...
                `WORLD: The character's world or setting of origin. To decide: gather every proper noun in the Original Details and Original Tags - the character's own name, other named characters, codenames, places, factions, and distinctive terminology - and ask whether they collectively identify one published work you can name with confidence. If they do (a famously distinctive character name, or several names and terms that all belong to the same work), name that setting. If the details are generic and the only evidence is a common or ordinary name, write 'Original' instead - even if the name coincides with someone from published media - and invent a brief fitting synopsis from the details provided. Attribution must rest on specific identifiers like these; never attribute from genre, tone, or stylistic resemblance alone. Follow the setting name (or 'Original') with a brief synopsis of that world's defining features and the character's place in it.\n` +
